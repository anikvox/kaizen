...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen bg-background text-foreground selection:bg-blue-600 selection:text-white font-sans">
      ...
      <header className="sticky top-0 px-0 md:p-2 w-full flex justify-center items-center z-50 bg-background/80 backdrop-blur-sm">
        <Navbar />
      </header>

      <main className="relative flex flex-col min-h-screen w-full px-2 md:px-0 overflow-x-hidden z-10">
        <Hero />
